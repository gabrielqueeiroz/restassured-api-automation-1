...
public class LoadDatabase {
    ...
    CommandLineRunner initDatabaseRestricao(RestricaoRepository restricaoRepository) {
        return args -> {
            restricaoRepository.save(new Restricao("97093236014", TipoRestricao.BLOQUEIO_JUDICIAL.value()));
            ...
            restricaoRepository.save(new Restricao("19626829001", TipoRestricao.BLOQUEIO_JUDICIAL.value()));
